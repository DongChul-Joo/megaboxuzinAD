package com.zinsupark.security;
...
import com.zinsupark.member.Member;
import com.zinsupark.member.MemberService;
...
public class LoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest req,
		...
		info.setAdminId(member.getUserId());
		info.setAdminName(member.getUserName());
